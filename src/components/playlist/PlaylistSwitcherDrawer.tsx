...
import { Globe, Link as LinkIcon, Lock, Play } from "lucide-react";
...
export function PlaylistSwitcherDrawer({
	children,
}: PlaylistSwitcherDrawerProps) {
	const auth = useAuth();
											...
											<div className="flex-1 min-w-0">
												...
												<div className="flex items-center gap-2 mt-1">
													...
													{isCurrentPlaylist(playlistItem.id) && (
														<Badge
															variant="outline"
															className="gap-1 px-2 py-0.5 h-5 text-xs bg-green-700/20 border border-green-600 text-green-300"
														>
